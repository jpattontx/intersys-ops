...
# By default all data nodes will be masters
default.elasticsearch[:master_data_nodes] = "true"
...
default.elasticsearch[:host]          = "http://build:8082"
default.elasticsearch[:repository]    = "files/elasticsearch"
...
default.elasticsearch[:path][:bin] = "#{node.elasticsearch[:dir]}/elasticsearch/bin"
...
default.elasticsearch[:path][:masterlogs] = "/var/log/elasticsearch-master"
...
default.elasticsearchmaster[:pid_file]  = "#{node.elasticsearch[:pid_path]}/#{node.elasticsearch[:node][:name].to_s.gsub(/\W/, '_')}-master.pid"
...
#
default.elasticsearch[:allocated_memory_pct_of_heap] = 0.6
allocated_memory_int = (((node.memory.total.to_i * node.elasticsearch[:allocated_memory_pct_of_heap] ).floor / 1024)/32).ceil * 32
allocated_memory = "#{allocated_memory_int}m"
...
default.elasticsearch[:backup][:dd_mount] = "/mnt/autofs/es-backups"
default.elasticsearch[:backup][:snapshot_size] = "100G"
#default.elasticsearch[:backup][:pipelinedb][:hostname]
default.elasticsearch[:backup][:pipelinedb][:database] = "onesource_pi_1"
default.elasticsearch[:backup][:pipelinedb][:username] = "readonly"
default.elasticsearch[:backup][:pipelinedb][:password] = "readonly"
...
default.elasticsearchmaster[:http][:port] = 19200
